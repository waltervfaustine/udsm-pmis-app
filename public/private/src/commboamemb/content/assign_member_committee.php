...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <h2 class="panel-title">User Registered as Committee Members</h2>
    </div>
        <?php
            global $DBInstance;
        ...
        <div class="panel-body" id="committees_approved_content_area">
            <table class="table table-bordered table-hover">
                <div class="collapse" id="committee_membership_edit_btn">
                    <div class="well">
                        <form action="actioncommem.php?pg=1" method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><label class="input-group-text" for="collapse_board_id">Assign Member To A Committee</label></span>
                                        <?php $listofcommittees = Committee::getAll(); ?>
                                        <select class="form-control" id="collapse_committee_id" name="collapse_committee_id">
                                            <option selected>Choose...</option>
                                            <option value="-1" selected>Unsigned Membership</option>
                                    ...
                                    <button class="btn btn-primary pull-right" id="assign_committee_membership_btn" type="submit" name="assign_committee_member">Assign Membership</button>
                                    </span>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="hidden" id="collapse_committee_member_id" name="collapse_committee_member_id">
                            </div>
                        </form>
                    </div>
                </div>
                <thead>
                    <tr>
                        ...
                        <th class="info text-center">MemberSince</th>
                        <th class="info text-center">Committee Name</th>
                ...
                <tbody>
                    ...
                    <?php global $DBInstance; ?>
                        <?php if($committee->role_name == "committee"): ?>
                        <?php $counter = 1; ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <?php if($committee->role_name == 'committee'): ?>
                                    <td class="text-center"><button type="button" class="btn btn-primary btn-xs text-center">Committee Member</button></a></td>
                                <?php endif; ?>

                                <td class="text-center"><?php echo $DBInstance->escapeValues($committee->computeTime($committee->timestamp)); ?></td>

                                <?php
                                    if($committee->role_name == "committee") {
                                        $assigned_board = Committee::getByID($committee->designated_id);
                                    }
                                ?>
                                ...
                                <td class="">
                                    <button type="button" id="assign_committee_membership" class="btn btn-info btn-xs center-block assign_committee_membership_btn" data-toggle="collapse" data-target="#committee_membership_edit_btn" aria-expanded="false" aria-controls="committee_membership_edit_btn">
                                        Assign Committee
                                    </button>
                                </td>
