...
<body>
    <div class="container-fluid admin-position">
        <div class="row">
            ...
            <?php $siteURL = SITE_ROOT.DS.'public'.DS.'private'.DS.'src'.DS.'commboamemb'.DS.'content'; ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-9 valign-top cainam-scroll">
                        <div id="committeeboard_alert_message" class="message"><?php if(!empty($session->message)){ echo output_message($session->message); } ?></div>
    ...
    <script src="../../../js/committeeboard.js"></script>
</body>
</html>