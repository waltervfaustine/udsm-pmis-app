...
<body>
    <div class="container-fluid admin-position">
        <div class="row">
            ...
            <?php $siteURL = SITE_ROOT.DS.'public'.DS.'private'.DS.'src'.DS.'commboard'.DS.'content'; ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div id="committee_message_div" class="message"><?php if(!empty($session->message)){ echo output_message($session->message); } ?></div>
