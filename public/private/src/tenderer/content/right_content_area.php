<div class="col-md-7">
    <div class="panel panel-default">
        ...
        <div class="panel-body" id="tender_category_content_area">
            <table class="table table-bordered table-hover">
                ...
                <thead>
                    <tr>
                        <th class="info text-center"><span class="glyphicon glyphicon-expand"></span></th>
                ...
                <tbody>
                    ...
                    <?php global $DBInstance; ?>
                        <tr>
                            <td class="text-center"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderCategory->id); ?></td>
    ...
    <div class="panel panel-default">
        <div id="content" class="panel-heading">
        <h2 class="panel-title">Update and Delete Business Categories</h2>
    </div>
        <?php
            global $DBInstance;
        ...
        <div class="panel-body" id="business_category_content_area">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <?php global $DBInstance; ?>
                        <tr>
                            <td class="text-center"><?php echo $DBInstance->HTMLEntitiesDecoding($businessCategory->id); ?></td>
