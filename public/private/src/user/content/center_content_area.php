            ...
            <div class="panel panel-default">
                        ...
                        <div class="span6">
                            <table class="table table-condensed table-responsive table-user-information">
                                <tbody>
                                                ...
                                                <?php 
                                                    if(isset($_SESSION['status'])) {
                                                        if($_SESSION['status'] == 'verified') {
                                                            echo "Verified";
                                                        }else if($_SESSION['status'] == 'unverified') {
                                                            echo "UNVerified";
                                                        }
                                                    } 
                                                ?>
                                    ...
                                    <tr>
                                        <td>Registered</td>
                                        <td><?php echo timeAgo($_SESSION['ago']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Registered Since:</td>
                                        <td><?php echo $_SESSION['since'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Rgistered By:</td>
                                        <td><?php echo $_SESSION['addedby']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="panel-footer">
                    <button class="btn  btn-primary" type="button"
                            data-toggle="tooltip"
                            data-original-title="Send message to user"><i class="icon-envelope icon-white">Registered Since: <?php echo $_SESSION['since']; ?></i></button>
                    <span class="pull-right">
                        ...
                        <button class="btn btn-danger" type="button"
                                data-toggle="tooltip"
                                data-original-title="Remove this user">Registered By: <?php echo $_SESSION['addedby']; ?><i class="icon-remove icon-white"></i></button>
                    </span>
                </div>
            </div>
        </div>
