        ...
        <div class="panel-body">
            <form action="actionnw.php?pg=1" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="story_body" name="story_body" rows="3" placeholder="Public Story Description..."><?php if (!empty($_SESSION['story_body'])) {echo $_SESSION['story_body']; } ?></textarea>
                </div>
                <div class="form-group">
        ...
        <div class="panel-body">
            <form action="actionps.php?pg=1" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="news_body" name="news_body" rows="3" placeholder="News Update Body"></textarea>
                </div>
                <div class="checkbox"></div>
