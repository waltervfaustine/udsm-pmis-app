...
<body>
    <div class="container-fluid admin-position">
        <div class="row">
            <?php $siteURL = SITE_ROOT.DS.'public'.DS.'private'.DS.'src'.DS.'commboassign'.DS.'content'; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 valign-top cainam-scroll">
                        ...
                        <div class="row content-padding">
                            <div class="content-padding-right"> <?php include_layout_template($siteURL, 'accounting_officer_assign.php') ?> </div>
                        </div>
                    </div>
                </div>
            </div>
