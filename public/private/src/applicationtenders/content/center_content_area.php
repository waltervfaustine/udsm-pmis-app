        ...
        <div class="panel-body" id="tender_status_content_area">
            <table class="table table-bordered table-hover">
                <div class="collapse" id="tender_application_awarding">
                    <div class="well">
                        <form action="actionassignwinning.php/index.php?pg=1" method="post" enctype="multipart/form-data">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="info text-center">Awarding</th>
                        <th class="info text-center">AwardLetter</th>
                ...
                <?php $counter = 1; ?>
                    ...
                    <?php global $DBInstance; ?>
                        ...
                        <?php if($tenders->requesteruid == $_SESSION['currentUID'] && $tenderApplication->tenderid == $tenders->id && $_SESSION['currentRole'] == "UDSM Employee" && $tenders->status == "ongoing"): ?>
                            <tr>
                                ...
                                <td class="hidden text-center"><a class="btn btn-primary btn-sm" href="../generalfunc/download.php?id=<?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->id); ?>" role="button">Download</a></td>
                                ...
                                <?php elseif($tenderApplication->award == 'true' && $tenderApplication->status == 'false'): ?>
                                    <td class="text-center"><button class="btn btn-info btn-sm">Not Awarded</button></td>
                                <?php else: ?>
                                    <td class="text-center"><button class="btn btn-info btn-sm">Not Awarded</button></td>
                                <?php endif; ?>
                        ...
                        <?php else: ?>
                            <tr>
                                <td class=""><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->id); ?></td>
                                <td class=""><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->comment); ?></td>
                                <td class="hidden"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->stakeholderid); ?></td>
                                <td class="hidden"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->status); ?></td>
                                <td class="hidden"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->tenderid); ?></td>
                                <td class="text-center"><?php echo date("l jS \of F Y h:i:s A", $DBInstance->HTMLEntitiesDecoding($tenderApplication->timestamp)); ?></td>
                                <td class="hidden"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->type); ?></td>
                                <td class="text-center"><?php echo $DBInstance->HTMLEntitiesDecoding($tenderApplication->size_as_text($tenderApplication->size)); ?></td>
