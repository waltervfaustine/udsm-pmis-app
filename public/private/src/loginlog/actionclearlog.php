...
<?php 
    ...
    if(isset($_GET['clr'])){
        if($_GET['clr'] == 'true'){
			...
			clearLoginLogAction("Logs Data Deletion", $_SESSION['currentRole'], $systemuser->phone, $systemuser->email, "Last time log was cleared By: $systemuser->fname $systemuser->lname");
