<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <?php
            ...
            $total_count = TenderApplication::getCountYourTenders($_SESSION['stakeholder-uid']);
        ?>
            ...
            <table class="table table-bordered table-hover">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="info text-center">Award</th>
                        <th class="info text-center">AwardingLetter</th>
                        ...
                        <?php if($tenderApplication->stakeholderid == $_SESSION['stakeholder-uid']): ?>
                            <tr>
                                ...
                                <?php if($tenderApplication->award == 'false' && $tenderApplication->status == 'false'): ?>
                                    ...
                                    <td class="text-center"><button class="btn btn-info btn-sm">No Award Letter</button></td>
