var decl = [
    tender_category = {
        tender_category_title: document.getElementById("tender_category_title"),
        tender_category_body: document.getElementById("tender_category_body"),
        collapse_tender_category_title: document.getElementById("collapse_tender_category_title"),
...
var implementum = [
    {
        firstLetterToCaps: function (implementumID, statusMSG) {
            ...
            function changeFirstLetterToUpper() {
                decl[0].tender_category_title.value = decl[0].tender_category_title.value.charAt(0).toUpperCase() + decl[0].tender_category_title.value.slice(1).toLowerCase();
                ...
                if (implementumID == decl[0].tender_category_title) {
                    console.log("TITLE SELECTED FIRST");
                    if (decl[0].tender_category_title.value.length < 1 && decl[0].tender_category_body.value.length >= 1) {
                        decl[0].tender_category_submit_btn.disabled = true;
                        decl[0].tender_category_title.style.border = "";
                    ...
                    } else if (decl[0].tender_category_title.value.length >= 1 && decl[0].tender_category_body.value.length < 1) {
                        decl[0].tender_category_submit_btn.disabled = true;
                        decl[0].tender_category_title.style.border = "";
                        // console.log("Body empty");
                        if ((decl[0].tender_category_title.value.match(decl[2].symbol) || decl[0].tender_category_title.value.match(decl[2].num))) {
                            console.log("BAD TITLE");
                            var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
                            decl[0].message_div.innerHTML = status_msg + " " + decl[1].bad_mood;
                            decl[0].message_div.style.display = "block";
                            decl[0].tender_category_title.style.border = "2px solid red"
                            decl[0].tender_category_submit_btn.disabled = true;
                            decl[0].tender_category_body.style.border = "";
                        } else if ((!decl[0].tender_category_title.value.match(decl[2].symbol) || !decl[0].tender_category_title.value.match(decl[2].num))) {
                    ...
                    if (decl[0].tender_category_body.value.length < 1 && decl[0].tender_category_title.value.length >= 1) {
                        decl[0].tender_category_submit_btn.disabled = true;
                        decl[0].tender_category_title.style.border = "";
                        // console.log("Body empty");
                        if ((decl[0].tender_category_title.value.match(decl[2].symbol) || decl[0].tender_category_title.value.match(decl[2].num))) {
                    ...
                    } else if (decl[0].tender_category_body.value.length >= 1 && decl[0].tender_category_title.value.length < 1) {
                        decl[0].tender_category_submit_btn.disabled = true;
                        decl[0].tender_category_title.style.border = "";
                ...
                if (implementumID == decl[0].collapse_tender_category_title) {
                    console.log("TITLE SELECTED FIRST");
                    if (decl[0].collapse_tender_category_title.value.length < 1 && decl[0].collapse_tender_category_body.value.length >= 1) {
                        decl[0].tender_category_update_btn.disabled = true;
                        decl[0].collapse_tender_category_title.style.border = "";
                        ...
                        // console.log("Title empty");
                    } else if (decl[0].collapse_tender_category_title.value.length >= 1 && decl[0].collapse_tender_category_body.value.length < 1) {
                        decl[0].tender_category_update_btn.disabled = true;
                        decl[0].collapse_tender_category_title.style.border = "";
                        // console.log("Body empty");
                        if ((decl[0].collapse_tender_category_title.value.match(decl[2].symbol) || decl[0].collapse_tender_category_title.value.match(decl[2].num))) {
                            console.log("BAD TITLE");
                            var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
                            decl[0].message_div.innerHTML = status_msg + " " + decl[1].bad_mood;
                            decl[0].message_div.style.display = "block";
                            decl[0].collapse_tender_category_title.style.border = "2px solid red"
                            decl[0].tender_category_update_btn.disabled = true;
                            decl[0].collapse_tender_category_body.style.border = "";
                        } else if ((!decl[0].collapse_tender_category_title.value.match(decl[2].symbol) || !decl[0].collapse_tender_category_title.value.match(decl[2].num))) {
                            console.log("GOOD TITLE");
                            decl[0].tender_category_update_btn.disabled = true;
                            decl[0].collapse_tender_category_title.style.border = "";
                        }
                    ...
                    console.log("BODY SELECTED FIRST");
                    if (decl[0].collapse_tender_category_body.value.length < 1 && decl[0].collapse_tender_category_title.value.length >= 1) {
                        decl[0].tender_category_update_btn.disabled = true;
                        decl[0].collapse_tender_category_title.style.border = "";
                        // console.log("Body empty");
                        if ((decl[0].collapse_tender_category_title.value.match(decl[2].symbol) || decl[0].collapse_tender_category_title.value.match(decl[2].num))) {
                    ...
                    } else if (decl[0].collapse_tender_category_body.value.length >= 1 && decl[0].collapse_tender_category_title.value.length < 1) {
                        decl[0].tender_category_update_btn.disabled = true;
                        decl[0].collapse_tender_category_title.style.border = "";
...
decl[0].tender_category_title.onfocus = function () {
    var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
    implementum[0].firstLetterToCaps(decl[0].tender_category_title, status_msg);
};
...
decl[0].tender_category_title.onblur = function () {
    var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
    implementum[0].firstLetterToCaps(decl[0].tender_category_title, status_msg);
};
...
decl[0].collapse_tender_category_title.onfocus = function () {
    var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
    implementum[0].firstLetterToCaps(decl[0].collapse_tender_category_title, status_msg);
};
...
decl[0].collapse_tender_category_title.onblur = function () {
    var status_msg = "Tender Category Title can not contains numbers and specials symbols eg: 12345#$%";
    implementum[0].firstLetterToCaps(decl[0].collapse_tender_category_title, status_msg);
};
