        ...
        <?php foreach($tenders as $tender): ?>
            <?php if($tender->status == 'closed'): ?>
                ...
                <?php elseif($tender->status == 'closed'): ?>
                    <div class="">
                        <div class="" id="headingOne">
                            <img src="svg/arrow-right.svg" alt=""> <button class="btn btn-danger btn-xs" value=<?php echo $tender->status; ?>></button><a href="tenderinfo.php?tid=<?php echo $tender->id; ?>"> <?php echo $tender->title; ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            <?php else: ?>
